...
const photos = ref([
  ...
  { image: new URL('../assets/relax/640 (7).png', import.meta.url).href, title: '小吃街', description: '小吃街永远飘着一股惹人嘴馋的味道，东苑离新教不远。从新教学楼一路走过来，你会看到茶百道，书亦烧仙草等奶茶店。每到饭点一定会满座的五谷渔粉，滋滋作响的纸包鱼，咕噜咕噜翻滚着的火锅串串鸡公煲，滋滋发出声响的烤肉,一滴热油顺着饱满的肉的纹路慢慢滑下,令人心醉，香气四溢的冒菜伴着满街的吆喝声，不停上菜的服务员的步伐，意外的和谐。东苑除了这些硬菜，还有良品铺子，前不久新开的面包店，里面的欧包真的可以和网红店媲美，东苑的超市总是人头攒动。' },
